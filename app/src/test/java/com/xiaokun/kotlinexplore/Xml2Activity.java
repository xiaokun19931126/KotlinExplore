...
public class Xml2Activity {
    ...
    public String xmlPathDir;
    public String activityPathDir;
    public String separator = "\\";

    @Test
    public void main() {
        xmlPathDir = "D:\\AndroidStudioProjects\\KotlinExplore\\app\\src\\main\\res\\layout" + separator;
        activityPathDir = "D:\\AndroidStudioProjects\\KotlinExplore\\app\\src\\main\\java\\com\\xiaokun\\kotlinexplore" + separator;

        //你的Activity布局xml所在路径
        File file = new File(xmlPathDir + "activity_home.xml");
